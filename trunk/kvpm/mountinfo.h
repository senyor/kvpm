...
Q_OBJECT
 ...
 public:
    explicit MountInformation(mntent *const mountTableEntry, const QList<mntent *> mountTable, QObject *parent = 0);
    explicit MountInformation(mntent *const mountTableEntry, QObject *parent = 0);
